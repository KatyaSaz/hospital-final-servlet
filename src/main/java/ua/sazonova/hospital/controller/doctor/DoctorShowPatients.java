...
public class DoctorShowPatients extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Doctor doctor = doctorService.getDoctorById(docID, LocalService.getLanguage(req));
        req.setAttribute(Const.DOCTOR, doctor);
        req.setAttribute(Const.PATIENTS, doctorService.getPatientsOfDoctor(doctor, LocalService.getLanguage(req)));
        rd.forward(req, resp);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (sortField != null && sortDirection != null) {
            ...
            req.setAttribute(Const.PATIENTS,
                    adminService.sortPatientsOfOneDoctor(docID, sortField, sortDirection, LocalService.getLanguage(req)));
