...
public class AdminAllNonReg extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.setAttribute(Const.DOCTORS, adminService.getNonActiveDoctors(LocalService.getLanguage(req)));
        req.setAttribute(Const.PATIENTS, adminService.getNonActivePatients(LocalService.getLanguage(req)));
        rd.forward(req, resp);
    }
